...
public class Profesor {
    ...
    public Profesor(int num_personal,String password){
    ...
    public Profesor(int personalNumber, String password, String name, String lastname){
        
        connection = dbc.startConnection();
        password = Encrypter.hasher(password);
        LocalDate localdate = LocalDate.now();
        
        query = "insert into Profesor(num_personal, contrasena, nombre, apellido_paterno, fecha_registro) values(?,?,?,?,?);";
    ...
    public boolean verifyPassword(int num_personal,String password){
        ...
        dbc.startConnection();
        try{
            query = "Select contrasena from profesor where num_personal = '"+ String.valueOf(num_personal) +"';";
            PreparedStatement preparedStatement = connection.prepareStatement(query);
